...
const TableUsers: FC<TableUsersProps> = props => {
  ...
  return (
    <Card>
      <CardHeader action={props.children} title='Usuarios' titleTypographyProps={{ variant: 'h6' }} />
      <TableContainer>
                  ...
                  <TableCell sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    {hasWriteUsers && (
                      <>
                        ...
                        >
                          <Typography color={'white'}>Editar Contraseña</Typography>
                        </Button>
                        <Button
                          variant='contained'
                          onClick={() => {
                        ...
                        >
                          <Typography color={'white'}> Editar Permisos</Typography>
                        </Button>
                      </>
                    )}
                  </TableCell>
